import svgPaths from "./svg-yuqo9vdhm5";
import imgChatGptImageJul282026031420Pm1 from "./53d300dbc7272b8264e43e2a91b9daa01b66a922.png";
...
function Frame() {
  return (
    <div className="absolute h-[861px] left-0 overflow-clip top-[-273px] w-[393px]">
      <div className="absolute h-[651px] left-[-39px] top-[210px] w-[433px]" data-name="ChatGPT Image Jul 28, 2026, 03_14_20 PM 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgChatGptImageJul282026031420Pm1} />
      </div>
    </div>
  );
}
...
export default function CloseTheDay() {
  return (
    <div className="bg-[#faf8f7] overflow-clip relative rounded-[30px] size-full" data-name="Close the Day">
      <Frame />
      <CloseTheDay1 />
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[1.2] left-[196.5px] not-italic text-[#063235] text-[22px] text-center top-[620px] tracking-[-0.5px] whitespace-nowrap">Someone Stranded</p>
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Regular',sans-serif] font-normal h-[50px] leading-[1.4] left-[196.5px] not-italic text-[#063235] text-[16px] text-center top-[654px] tracking-[-0.5px] w-[303px]">Someone up ahead could use a hand. Pull over and help them get back on their way.</p>
