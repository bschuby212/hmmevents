import svgPaths from "./svg-bwai1jmail";
import imgChatGptImageJul252026072149Pm1 from "./bb30095c4684d0e28a22583fcb2b674724515ddb.png";
...
function Frame() {
  return (
    <div className="absolute h-[861px] left-0 overflow-clip top-[-273px] w-[393px]">
      <div className="absolute h-[884px] left-[-52px] top-[80px] w-[497px]" data-name="ChatGPT Image Jul 25, 2026, 07_21_49 PM 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgChatGptImageJul252026072149Pm1} />
      </div>
    </div>
  );
}
...
export default function CloseTheDay() {
  return (
    <div className="bg-[#faf8f7] overflow-clip relative rounded-[30px] size-full" data-name="Close the Day">
      <Frame />
      <CloseTheDay1 />
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[1.2] left-[196.5px] not-italic text-[#063235] text-[22px] text-center top-[620px] tracking-[-0.5px] whitespace-nowrap">Dysentery</p>
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Regular',sans-serif] font-normal h-[50px] leading-[1.4] left-[196.5px] not-italic text-[#063235] text-[16px] text-center top-[654px] tracking-[-0.5px] w-[303px]">The journey took an unexpected turn. Find a place to stop and take care of yourself.</p>
